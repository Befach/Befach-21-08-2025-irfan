...
import { FaCheckCircle, FaCircle, FaPhone, FaComment, FaTruck, FaPlane, FaShip, FaTrain, FaClock } from 'react-icons/fa';
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="mb-6">
                  <div className="flex justify-between mb-2">
                    <p className="text-lg font-medium">Shipment Progress</p>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <p className="text-lg text-gray-700 font-medium">Current Progress</p>
                  </div>
                </div>
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-400">
                    <div className="flex items-center">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium text-blue-800 mb-2">Last Updated</p>
